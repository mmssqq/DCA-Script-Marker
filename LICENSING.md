...
DCA Script Marker is free software: you may redistribute it and/or modify it
under the terms of the GNU Affero General Public License as published by the
Free Software Foundation, either version 3 of the License, or (at your option)
any later version. The complete licence text is in [LICENSE](LICENSE).
...
The copyright holder may also offer the original DCA Script Marker code under
separate terms. This does not withdraw or reduce any rights already granted to
recipients under the GNU AGPL.
